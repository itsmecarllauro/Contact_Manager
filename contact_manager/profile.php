...
<head>
    ...
    <title>Profile Settings - Contact Manager</title>
...
<body class="bg-gradient-to-r from-blue-100 via-white to-blue-100 min-h-screen flex items-center justify-center">
    <div class="bg-white p-10 rounded-xl shadow-lg w-full max-w-md">
        ...
        <form method="POST" action="profile.php" novalidate>
            ...
            <input class="w-full p-3 mb-5 border border-gray-300 rounded-lg placeholder-gray-400 focus:ring-2 focus:ring-blue-500 transition" type="text" id="name" name="name" placeholder="John Doe" value="<?= htmlspecialchars($user['name'] ?? '') ?>" required />

            <label class="block mb-2 font-semibold text-gray-700" for="email">Email</label>
            <input class="w-full p-3 mb-5 border border-gray-300 rounded-lg placeholder-gray-400 focus:ring-2 focus:ring-blue-500 transition" type="email" id="email" name="email" placeholder="you@example.com" value="<?= htmlspecialchars($user['email'] ?? '') ?>" required />

            <hr class="my-6" />

            <label class="block mb-2 font-semibold text-gray-700" for="current_password">Current Password</label>
            <input class="w-full p-3 mb-5 border border-gray-300 rounded-lg placeholder-gray-400 focus:ring-2 focus:ring-blue-500 transition" type="password" id="current_password" name="current_password" placeholder="********" />

            <label class="block mb-2 font-semibold text-gray-700" for="new_password">New Password</label>
            <input class="w-full p-3 mb-5 border border-gray-300 rounded-lg placeholder-gray-400 focus:ring-2 focus:ring-blue-500 transition" type="password" id="new_password" name="new_password" placeholder="********" />

            <label class="block mb-2 font-semibold text-gray-700" for="confirm_password">Confirm New Password</label>
            <input class="w-full p-3 mb-8 border border-gray-300 rounded-lg placeholder-gray-400 focus:ring-2 focus:ring-blue-500 transition" type="password" id="confirm_password" name="confirm_password" placeholder="********" />

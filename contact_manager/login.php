...
<body class="bg-gradient-to-r from-blue-100 via-white to-blue-100 flex items-center justify-center min-h-screen">
    <div class="bg-white p-10 rounded-xl shadow-lg w-full max-w-md">
        <h1 class="text-3xl font-extrabold mb-8 text-center text-blue-700">Welcome Back</h1>
        <?php if ($errors): ?>
        ...
        <form method="POST" action="login.php" novalidate>
            ...
            <input class="w-full p-3 mb-6 border border-gray-300 rounded-lg placeholder-gray-400 focus:ring-2 focus:ring-blue-500 transition" type="password" id="password" name="password" placeholder="********" required />

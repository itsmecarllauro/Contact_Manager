...
<body class="bg-gradient-to-r from-blue-100 via-white to-blue-100 min-h-screen">
    <nav class="bg-white shadow p-6 flex justify-between items-center max-w-7xl mx-auto">
        ...
        <div>
            ...
            <a href="profile.php" class="mr-6 text-blue-600 font-semibold hover:underline">Profile</a>
                        ...
                        <?php foreach ($contacts as $contact): ?>
                            <tr class="border-t border-gray-200 hover:bg-blue-50 transition">
                                ...
                                <td class="py-3 px-6 space-x-4">
                                    <a href="edit_contact.php?id=<?= $contact['id'] ?>" class="text-blue-600 font-semibold hover:underline">Edit</a>
                                    <a href="dashboard.php?delete=<?= $contact['id'] ?>" onclick="return confirm('Are you sure you want to delete this contact?');" class="text-red-600 font-semibold hover:underline">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
